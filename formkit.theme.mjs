/**
  ...
  *
  * @checksum - d218913213a518230afbf2d022ada9ed76a3a633a0f654b622c73d81a686354a
  * @variables - radius=rounded-lg,accentColor=indigo,colorTemperature=stone,spacing=2,scale=base,inputShadow=shadow,baseColorShade=600,borderShadeLightMode=200,borderShadeDarkMode=500,inputMaxWidth=max-w-none,tagRadius=rounded,swatchRadius=rounded
  * @theme - regenesis
  **/
...
const classes = {
  ...
  "color__inner": {
    ...
    "group-data-[prefix-icon]:border-stone-200": true,
    "group-data-[suffix-icon]:border": true,
    "group-data-[suffix-icon]:border-stone-200": true,
  ...
  "submit__input": {
    ...
    "disabled:border-stone-200": true,
  ...
  "slider__minValue": {
    ...
    "[&>div>div::after]:bg-stone-200": true,
  ...
  "multi-step__tabs": {
    ...
    "group-data-[tab-style=tab]/wrapper:border-stone-100": true,
